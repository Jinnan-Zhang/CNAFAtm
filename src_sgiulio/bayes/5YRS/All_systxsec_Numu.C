void All_systxsec_Numu(){
  ...
  std::ofstream rel_err("outputs_xsec_Numu/xsecerror_Numu_7_8.txt");
  ...
  TH2F *Flux_var_h = new TH2F("Flux_var_h","",7,-0.3,1.2,200,1.E-7,1.0);
  ...
  for (int k=1; k<=1000; k++) {
    sprintf(input_file,"outputs_xsec_Numu/Unf_spectrum-%i_7_8.txt",k);
  ...
  fitratio->GetYaxis()->SetRangeUser(0.61,1.39);
  fitratio->SetTitle("");
  ...
  f_out->Close();
  cfin->SaveAs("plot_err/systxsec_numu.pdf");
