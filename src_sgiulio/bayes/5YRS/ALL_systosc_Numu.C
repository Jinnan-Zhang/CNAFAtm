void ALL_systosc_Numu(){
  ...
  std::ofstream rel_err("outputs_systosc_Numu/systosc_err_Numu_7_8.txt");
  TFile *f_out = new TFile("outputs_systosc_Numu/systosc_Numu_7_8.root", "RECREATE");
  ...
  Float_t scale_factor[7] = {0.055,0.022,0.0085,2.5E-3,0.7E-3,2.0E-4,0.52E-4};
  ...
  for (int k=0; k<=1000; k++) {
    sprintf(input_file,"outputs_systosc_Numu/Unf_spectrum-%i_7_8.txt",k);
  ...
  f_out->Close();
  cfin->SaveAs("plot_err/systosc_numu.pdf");
}
