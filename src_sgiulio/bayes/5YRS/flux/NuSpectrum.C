void NuSpectrum() {
  ...
  TFile *_file0 = TFile::Open("/storage/DATA-02/juno/Users/sgiulio/Atmo/analysis/unfolding/bayes/output_Numu_osc/plot_8_8.root");
  ...
  TFile *_file1 = TFile::Open("/storage/DATA-02/juno/Users/sgiulio/Atmo/analysis/unfolding/bayes/output_Nue_osc/plot_8_8.root");
  ...
  E_flux->SetMarkerSize(2);
  E_flux->SetMarkerColor(kRed);
  E_flux->SetLineWidth(4);
  ...
  leg1->AddEntry(H_Flux_Mu_noosc, "Honda #nu_{#mu} Flux (w/o osc.)", "l");
  leg1->AddEntry(H_Flux_Mu_osc, "Honda #nu_{#mu} Flux (w/ osc.)", "l");
  //leg1->AddEntry(Mu_flux, "Unfolded #nu_{#mu} flux", "pe");
  leg1->AddEntry(Mu_flux, "This work (8 yrs) #nu_{#mu}", "pe");
  leg1->AddEntry(Mu_SK_flux, "PRD 94, 052001 (#nu_{#mu})", "pe");
  leg1->SetBorderSize(0);
  leg2->AddEntry(H_Flux_E_noosc, "Honda #nu_{e} Flux (w/o osc.)", "l");
  leg2->AddEntry(H_Flux_E_osc, "Honda #nu_{e} Flux (w/ osc.)", "l");
  //leg2->AddEntry(E_flux, "Unfolded #nu_{e} flux", "pe");
  ...
  c1->SaveAs("Plot/Spec_mu.root");
  c2->SaveAs("Plot/Spec_e.png");
  c2->SaveAs("Plot/Spec_e.root");
}
