void All_systxsec_Nue(){
  ...
  for (int k=1; k<=1000; k++) {
    sprintf(input_file,"outputs_xsec_Nue/Unf_spectrum-%i_7_7.txt",k);
  ...
  std::cout << "file outputs_xsec_Nue/xsec_NPE_7_7.root created" << std::endl;
  f_out->Close();
  cfin->SaveAs("plot_err/systxsec_nue.pdf");
