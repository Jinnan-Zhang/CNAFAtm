...
#          output. 
#PBS -j oe
#PBS -o /storage/DATA-02/juno/Users/sgiulio/Atmo/analysis/unfolding/bayes/logs/batch_systcut_Nue.txt
#
##########################################
...
time ./run_systcut_DATA_Nue.sh > logs/log_systcut_Nue.txt
