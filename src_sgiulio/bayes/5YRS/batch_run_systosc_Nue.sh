...
#          output. 
#PBS -j oe
#PBS -o /storage/DATA-02/juno/Users/sgiulio/Atmo/analysis/unfolding/bayes/logs/batch_systosc_Nue.txt
#
##########################################
...
time ./run_systosc_DATA_Nue.sh > logs/log_systosc_Nue.txt
