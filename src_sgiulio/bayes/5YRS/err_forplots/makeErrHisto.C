void makeErrHisto() {
  ...
  TLegend *lege = new TLegend(0.34,0.63,0.74,0.97);
  ...
  TLegend *legmu = new TLegend(0.34,0.63,0.74,0.97);
  ...
  stat_nue_h->GetYaxis()->CenterTitle(true);
  stat_nue_h->GetYaxis()->SetTitleOffset(0.9);
  stat_nue_h->GetYaxis()->SetTitleSize(0.06);
  stat_nue_h->GetYaxis()->SetLabelSize(0.05);
  stat_nue_h->GetXaxis()->SetLabelSize(0.05);
  stat_nue_h->GetXaxis()->SetTitleSize(0.06);
  ...
  stat_numu_h->GetYaxis()->CenterTitle(true);
  stat_numu_h->GetYaxis()->SetTitleOffset(0.9);
  stat_numu_h->GetYaxis()->SetTitleSize(0.06);
  stat_numu_h->GetYaxis()->SetLabelSize(0.05);
  stat_numu_h->GetXaxis()->SetLabelSize(0.05);
  stat_numu_h->GetXaxis()->SetTitleSize(0.06); 
  ...
  TCanvas *cmu = new TCanvas("cmu","cmu",800,800);
  cmu->cd();  
