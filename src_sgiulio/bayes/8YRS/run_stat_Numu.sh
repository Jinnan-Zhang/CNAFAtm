...
MC-DATA-RATIO 50.
N_ITER 1
INPUT_FOLDER /storage/DATA-02/juno/Users/sgiulio/Atmo/analysis/unfolding/matrix/likelihood/output_Numu_osc/mod
OUTPUT_FOLDER outputs_stat_Numu
...
" > outputs_stat_Numu/run/config_Numu-$n
    echo "running $n spectrum..."
    ./Bayes.exe outputs_stat_Numu/run/config_Numu-$n
done
cp /storage/DATA-02/juno/Users/sgiulio/Atmo/analysis/unfolding/matrix/likelihood/output_Numu_osc/energybins_Numu_7.txt outputs_stat_Numu/.
