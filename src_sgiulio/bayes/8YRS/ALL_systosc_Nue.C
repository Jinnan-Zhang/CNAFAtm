void ALL_systosc_Nue(){
  ...
  std::ofstream rel_err("/storage/DATA-02/juno/Users/sgiulio/Atmo/analysis/unfolding/bayes/outputs_systosc_Nue/systosc_err_Nue_7_7.txt");
  TFile *f_out = new TFile("/storage/DATA-02/juno/Users/sgiulio/Atmo/analysis/unfolding/bayes/outputs_systosc_Nue/systosc_Nue_7_7.root", "RECREATE");
  ...
  Float_t scale_factor[7] = {0.38,0.17,0.05,0.012,0.002,2.3E-4,0.28E-4};
  ...
  */
  ...
  for (int k=1; k<=1000; k++) {
    sprintf(input_file,"/storage/DATA-02/juno/Users/sgiulio/Atmo/analysis/unfolding/bayes/outputs_systosc_Nue/Unf_spectrum-%i_7_7.txt",k);
