void ALL_systcut_Nue(){
  ...
  gStyle->SetOptStat(0);
  std::ifstream true_array("/storage/DATA-02/juno/Users/sgiulio/Atmo/analysis/unfolding/bayes/outputs_systcut_Nue/Unf_spectrum-75_7_7.txt");
  ...
  std::ofstream rel_err("/storage/DATA-02/juno/Users/sgiulio/Atmo/analysis/unfolding/bayes/outputs_systcut_Nue/systcut_err_Nue_7_7.txt");
  TFile *f_out = new TFile("/storage/DATA-02/juno/Users/sgiulio/Atmo/analysis/unfolding/bayes/outputs_systcut_Nue/systcut_Nue_7_7.root", "RECREATE");
  ...
  for (int k=0; k<=10; k++) {
    index = 70+k;
    sprintf(input_file,"/storage/DATA-02/juno/Users/sgiulio/Atmo/analysis/unfolding/bayes/outputs_systcut_Nue/Unf_spectrum-%i_7_7.txt",index);
