...
MC-DATA-RATIO 50.
N_ITER 1
INPUT_FOLDER /storage/DATA-02/juno/Users/sgiulio/Atmo/analysis/unfolding/matrix/likelihood/output_Nue_osc/mod
OUTPUT_FOLDER outputs_stat_Nue
...
" > outputs_stat_Nue/run/config_Nue-$n
    echo "running $n spectrum..."
    ./Bayes.exe outputs_stat_Nue/run/config_Nue-$n
done
cp /storage/DATA-02/juno/Users/sgiulio/Atmo/analysis/unfolding/matrix/likelihood/output_Nue_osc/energybins_Nue_7.txt outputs_stat_Nue/.
