...
#          output. 
#PBS -j oe
#PBS -o /storage/DATA-02/juno/Users/sgiulio/Atmo/analysis/unfolding/bayes/logs/batch_systosc_Numu.txt
#
##########################################
...
time ./run_systosc_DATA_Numu.sh > logs/log_systosc_Numu.txt
