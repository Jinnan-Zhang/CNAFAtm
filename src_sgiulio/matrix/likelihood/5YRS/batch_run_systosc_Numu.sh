...
#          output. 
#PBS -j oe
#PBS -o /storage/DATA-02/juno/Users/sgiulio/Atmo/analysis/unfolding/matrix/likelihood/5YRS/logs/batch_systosc_Numu.txt
#
##########################################
...
time ./run_systosc_Numu.sh > logs/log_systosc_Numu.txt 2>&1
