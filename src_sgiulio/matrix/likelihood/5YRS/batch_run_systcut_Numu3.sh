...
#          output. 
#PBS -j oe
#PBS -o /storage/DATA-02/juno/Users/sgiulio/Atmo/analysis/unfolding/bayes/logs/batch_systcut_Numu3.txt
#
##########################################
...
time ./run_systcut_DATA_Numu3.sh > logs/log_systcut_Numu3.txt
