...
#          output. 
#PBS -j oe
#PBS -o /storage/DATA-02/juno/Users/sgiulio/Atmo/analysis/unfolding/bayes/logs/batch_systcut_Numu1.txt
#
##########################################
...
time ./run_systcut_DATA_Numu1.sh > logs/log_systcut_Numu1.txt
