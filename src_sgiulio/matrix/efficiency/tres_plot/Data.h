...
// Thu Jun 27 17:04:25 2019 by ROOT version 6.12/06
// from TTree Data/Tree with custom variables
// found on file: /storage/DATA-02/juno/Users/sgiulio/Atmo/analysis/unfolding/treemaker/trees/MC_500K_1m_TOT_FULL.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
     ...
     //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/storage/DATA-02/juno/Users/sgiulio/Atmo/analysis/unfolding/treemaker/trees/DATA_5YRS_1m_TOT.root");
     TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/storage/gpfs_data/juno/junofs/users/sgiulio/Atmo/analysis/unfolding/treemaker/trees/MC_100K_1m_TOT_1.root");
      if (!f || !f->IsOpen()) {
	//f = new TFile("/storage/DATA-02/juno/Users/sgiulio/Atmo/analysis/unfolding/treemaker/trees/MC_500K_1m_TOT_NEW.root");
	//f = new TFile("/storage/DATA-02/juno/Users/sgiulio/Atmo/analysis/unfolding/treemaker/trees/DATA_5YRS_1m_TOT.root");
	f = new TFile("/storage/gpfs_data/juno/junofs/users/sgiulio/Atmo/analysis/unfolding/treemaker/trees/MC_100K_1m_TOT_1.root");
      }
