makeplots_nu_5msmear() {

  //TLegend * leg = new TLegend(0.1,0.9,0.4,0.7);
  TLegend * leg = new TLegend(0.7,0.9,0.9,0.7);
  gStyle->SetOptStat(0);
  gStyle->SetOptTitle(0);
  TFile *_file0 = TFile::Open("Plot/TRUEnue_0-10GeV_red_5m_CCpure.root");
  ...
  Time_residual_spread_all_h->GetYaxis()->SetRangeUser(0,500);
  Time_residual_spread_all_h->Draw();
  leg->AddEntry(Time_residual_spread_all_h, "#nu_{e} CC" ,"l");
  TFile *_file1 = TFile::Open("Plot/TRUEnumu_0-10GeV_red_5m_CCpure.root");
  Time_residual_spread_all_h->SetLineWidth(4);
  ...
  TFile *_file2 = TFile::Open("Plot/TRUEnue+numu_0-10GeV_red_5m_NCpure.root");
  Time_residual_spread_all_h->SetLineWidth(4);
  ...
  c3->SaveAs("Plot/tres_spread_nueCC+numuCC+nuCC_0-10GeV_16volcut_purecharge_5mV_ALL.pdf");
  c3->SaveAs("Plot/tres_spread_nueCC+numuCC+nuCC_0-10GeV_16volcut_purecharge_5mV_ALL.C");
  }
