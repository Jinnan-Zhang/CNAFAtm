makeplots_nu_1msmear() {

  //TLegend * leg = new TLegend(0.1,0.9,0.4,0.7);
  TLegend * leg = new TLegend(0.7,0.9,0.9,0.7);
  gStyle->SetOptStat(0);
  gStyle->SetOptTitle(0);
  TFile *_file0 = TFile::Open("Plot/TRUEnue_0-10GeV_red_1m_CCpure.root");
  ...
  TFile *_file2 = TFile::Open("Plot/TRUEnue+numu_0-10GeV_red_1m_NCpure.root");
  Time_residual_spread_all_h->SetLineWidth(4);
  ...
  c3->SaveAs("Plot/tres_spread_nueCC+numuCC+nuCC_0-10GeV_16volcut_purecharge_1mV_ALL.pdf");
  c3->SaveAs("Plot/tres_spread_nueCC+numuCC+nuCC_0-10GeV_16volcut_purecharge_1mV_ALL.C");
  }
